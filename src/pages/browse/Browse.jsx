...
import { FaFilm } from 'react-icons/fa'; // Importing an icon from react-icons
...
const Browse = () => {
  ...
  return (
    <>
      ...
      >
        <FaFilm className='text-5xl text-purple-500 mr-4 animate-spin-slow' />
        <h1 className='text-3xl font-extrabold text-white'>
          Find Your Next Favorite Movie Based on Your Mood
        </h1>
      </Link>
    </div>
